                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box align-items-center justify-content-between">
                                <h3 class="page-title">Department  
                                    <a href="add_department.php" class="btn btn-primary float-end">Add New Department</a></h3>
                            </div>
                        </div>
                    </div>
                    </div>
                                ...
                                <div class="box-body">
                                    <div class="table-responsive">
                                        <table id="ExportDataTable" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                                            ...
                                            <tbody>
                                            <?php 
                                                    $department = mysqli_query($db,"SELECT * FROM `department` WHERE deletedStatus='0' ORDER BY `ID` DESC");
                                                    $count = 1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="">
                                                            <a href="edit_department.php?id=<?php echo $read['ID']; ?>" onclick="return confirm('Are You Sure You Want To Edit This Record ?');" class="btn btn-success"><i class="fa fa-pencil"></i></a>

                                                            <a href="deleted_department.php?id=<?php echo $read['ID']; ?>" onclick="return confirm('Are You Sure You Want To Delete This Record ?');" class="btn btn-danger"><i class="fa fa-trash"></i>
                                                            </a>
