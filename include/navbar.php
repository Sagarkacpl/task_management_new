...
$query = "SELECT * FROM `users` WHERE Emp_designation='$designation'";
$nav_bar_valdate = mysqli_query($db,$query); 
						...
						<ul class="sidebar-menu" data-widget="tree">
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									<li><a href="department.php"><i class="icon-Commit"><span
													class="path1"></span><span class="path2"></span></i>Department</a>
									</li>
									<li><a href="designation.php"><i class="icon-Commit"><span
													class="path1"></span><span class="path2"></span></i>Designation</a>
									</li>
								</ul>
							</li>
							<li>
								<a href="employees.php">
									<i class="icon-Layout-4-blocks"><span class="fa fa-users"></span></i>
									<span>Employees</span>
								</a>								
							</li>
							<li>
								<a href="tasks.php">
									<i class="icon-Layout-4-blocks"><span class="fa fa-calendar"></span></i>
									<span>Tasks</span>
								</a>								
							</li>
							<li class="treeview">
							...
							<?php } elseif ($read['Emp_designation'] === 'Manager') { ?>
							<li>
								<a href="employees.php">
									<i class="icon-Layout-4-blocks"><span class="fa fa-users"></span></i>
									<span>Employees</span>
