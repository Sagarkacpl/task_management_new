                        ...
                        <div class="col-12">
                            <div class="page-title-box align-items-center justify-content-between">
                                <h3 class="page-title">Tasks List  
                                    <a href="add_new_task.php" class="btn btn-primary float-end">Add New Tasks</a></h3>
                            </div>
                        </div>
                    </div>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="ExportDataTable" class="table table-bordered table-hover display nowrap margin-top-10 w-p100">
                                            <thead>
                                                ...
                                                <?php 
                                                    // $show_emp = mysqli_query($db,"SELECT * FROM `users` WHERE DeletedStatus='0' ORDER BY ID DESC");
                                                    // $count = 1;
